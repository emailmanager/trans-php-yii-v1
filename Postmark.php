...
// Emailmanager constants are autodefined here, put your own settings in the main.php
// config array under "params"
$params = Yii::app()->params;
defined('EMAILMANAGERAPP_API_KEY') or define('EMAILMANAGERAPP_API_KEY',$params->emailmanagerApiKey);
defined('EMAILMANAGERAPP_MAIL_FROM_ADDRESS') or define('EMAILMANAGERAPP_MAIL_FROM_ADDRESS',$params->adminEmail);
defined('EMAILMANAGERAPP_MAIL_FROM_NAME') or define('EMAILMANAGERAPP_MAIL_FROM_NAME',$params->adminName);
